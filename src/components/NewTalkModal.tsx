...
const moduleName = 'NewTalkModal.tsx'
...
const NewTalkModal = () => {
    ...
    return (
        <Box sx={style}>
            ...
            <FormControl>
                <FormLabel>
                    <Typography variant="caption">新しいトークルーム名を入力してください</Typography>
                </FormLabel>
            </FormControl>
            ...
            />
            <Button variant="outlined" disableElevation onClick={submit} sx={{ marginTop: '1rem'}}>
                決定
            </Button>
        </Box>
	)
