    ...
    return (
        <Box sx={style}>
            ...
            <FormControl>
                ...
                <RadioGroup row defaultValue={() => settings.Theme} onChange={onThemeChange()}>
            ...
            <TextField fullWidth label="ChatGPT API Key" size="small" variant="standard" defaultValue={settings.ApiKey} onChange={onAPIKeyChange()} />
        </Box>
	)
}
